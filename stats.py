...
for repo in repos:
  ...
  commits_img = f"https://img.shields.io/github/commit-activity/t/{ORG_NAME}/{name}?color=green"
  forks_img = f"https://img.shields.io/github/forks/{ORG_NAME}/{name}?color=green"
  stars_img = f"https://img.shields.io/github/stars/{ORG_NAME}/{name}?color=green"
